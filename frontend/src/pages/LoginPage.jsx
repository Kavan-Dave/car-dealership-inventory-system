...
const LoginPage = () => {
  ...
  // Determine redirection target (default is dashboard)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect occurs automatically via the useEffect hook above
    } catch (err) {
      console.error("Login component submission failed:", err);
    } finally {
      setSubmitting(false);
    }
  };
